          	    ...
          	    return 0;
						...
						$(data).each(function (i, elem) {
							...
							if (imageCount > 1 && elem.eventHomepageImage && siteStyle.showSlider) {
								homepageImage += `<li><a title="new event link" class="homepageHeaderAnchor" href="${elem.eventUrl}"><img aria-hidden="true" alt="home page banner" src="app/uploads/${elem.eventHomepageImage}" /></a></li>`;
							}
					...
					if (imageCount === 1 || data.length <= 1 || siteStyle.showSlider === false) {
						...
						if (data[0] && data[0].eventHomepageImage) {
							homepageImage = `<a title="new event link" class="homepageHeaderAnchor" href="/${data[0].eventUrl}"><section id="headerImage" class="mobileWrapper"><img aria-hidden="true" alt="home page banner" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="./app/uploads/${data[0].eventHomepageImage}" /></section></a>`;
						}
