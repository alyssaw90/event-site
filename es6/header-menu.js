			...
			.then(function(siteStyle) {
				$.get('/events', function (data) {
					...
					<!-- begin Gray Desktop Main menu -->
		 			<nav tabindex="0" aria-label="Header Menu" role="navigation" class="grid flex desktop-menu gray-menu" id="mainNav">
          	  ...
          	  if (a === b) {
          	    return 0;
						...
						if (siteStyle.showPastEventsBanner && siteStyle.showSlider) {
							homepageImage += `<li><a title="new event link" class="homepageHeaderAnchor" tabindex="0" aria-disabled="true" href="/past-events"><section id="headerImage" class="mobileWrapper"><img alt="past events header" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/past-events-banner.jpg" /></section></a></li>`;
						}
						...
						$(data).each(function (i, elem) {
							...
							if (imageCount > 1 && elem.eventHomepageImage && siteStyle.showSlider) {
								homepageImage += `<li><a title="new event link" class="homepageHeaderAnchor" tabindex="0" aria-disabled="true" href="${elem.eventUrl}"><img alt="home page banner" src="uploads/${elem.eventHomepageImage}" /></a></li>`;
							}
					...
					if (imageCount === 1 || data.length <= 1 || siteStyle.showSlider === false) {
						...
						if (data[0] && data[0].eventHomepageImage) {
							homepageImage = `<a title="new event link" class="homepageHeaderAnchor" tabindex="0" aria-disabled="true" href="/${data[0].eventUrl}"><section id="headerImage" class="mobileWrapper"><img alt="home page banner" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/${data[0].eventHomepageImage}" /></section></a>`;
						}
					...
					if (!imageCount || (siteStyle.showPastEventsBanner && !siteStyle.showSlider && siteStyle.hideEventBanners)) {
						homepageImage = `<a class="homepageHeaderAnchor" title="past events link" tabindex="0" aria-disabled="true" href="/past-events"><section id="headerImage" class="mobileWrapper"><img alt="past events header" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/past-events-banner.jpg" /></section></a>`;
					}
