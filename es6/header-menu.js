          	  ...
          	  if (a === b) {
          	    return 0;
						...
						if (siteStyle.showPastEventsBanner && siteStyle.showSlider && !siteStyle.hideEventBanners) {
							homepageImage += `<li><a title="new event link" class="homepageHeaderAnchor" tabindex="-1" aria-disabled="true" href="/past-events"><section id="headerImage" class="mobileWrapper"><img style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/past-events-banner.jpg" /></section></a></li>`;
						}
					...
					if (!imageCount || siteStyle.hideEventBanners) {
						homepageImage = `<a class="homepageHeaderAnchor" title="past events link" tabindex="-1" aria-disabled="true" href="/past-events"><section id="headerImage" class="mobileWrapper"><img style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/past-events-banner.jpg" /></section></a>`;
					}
