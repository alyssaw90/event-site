          	  ...
          	  if (a === b) {
          	    return 0;
						...
						if (siteStyle.showPastEventsBanner && siteStyle.showSlider) {
							homepageImage += `<li><a title="past event link" class="homepageHeaderAnchor" href="/past-events"><section id="headerImage" class="mobileWrapper"><img aria-hidden="true" alt="past events header" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/past-events-banner.jpg" /></section></a></li>`;
						}
						...
						$(data).each(function (i, elem) {
							...
							if (i === 0) {
								upcomingPurpleMenu += '<a id="eventNavigationMenu" href="/' + elem.eventUrl + '">' + city + '&nbsp-&nbsp<span class="purpleSubMenu">' + startMonth + '&nbsp' + startYear + '</span></a>| ';
							}
							...
							if (imageCount > 1 && elem.eventHomepageImage && siteStyle.showSlider) {
								homepageImage += `<li><a title="new event link" class="homepageHeaderAnchor" href="${elem.eventUrl}"><img aria-hidden="true" alt="home page banner" src="uploads/${elem.eventHomepageImage}" /></a></li>`;
							}
					...
					if (imageCount === 1 || data.length <= 1 || siteStyle.showSlider === false) {
						...
						if (data[0] && data[0].eventHomepageImage) {
							homepageImage = `<a title="new event link" class="homepageHeaderAnchor" href="/${data[0].eventUrl}"><section id="headerImage" class="mobileWrapper"><img aria-hidden="true" alt="home page banner" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/${data[0].eventHomepageImage}" /></section></a>`;
						}
					...
					if (!imageCount || (siteStyle.showPastEventsBanner && !siteStyle.showSlider && siteStyle.hideEventBanners)) {
						homepageImage = `<a class="homepageHeaderAnchor" title="past events link" href="/past-events"><section id="headerImage" class="mobileWrapper"><img aria-hidden="true" alt="past events header" style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/past-events-banner.jpg" /></section></a>`;
					}
