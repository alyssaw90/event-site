...
var stickyFooter = exports.stickyFooter = function stickyFooter() {
	var $window = $(window);
...
var homepageStickyFooter = exports.homepageStickyFooter = function homepageStickyFooter() {
	var $window = $(window);
	var $document = $(document);
	var $footer = $('.foot');
	var $backToTopButton = $('.scroll-button');
...
var changeHeight = exports.changeHeight = function changeHeight(div) {
	$(div).css('height', 'auto');
	var tallestBlock = 0;
	$(div).each(function () {
...
var changeWidth = exports.changeWidth = function changeWidth(div) {
	var widestBlock = 0;
	$(div).css('width', 'auto');
	$(div).each(function () {
...
var addCSS = exports.addCSS = function addCSS(changeWidth, div, cssPropKey, smallScreenVal, largeScreenVal) {
...
var _commonFunctionsBuild = require('./common-functions.build.js');

var customFunctions = _interopRequireWildcard(_commonFunctionsBuild);
...
},{"./common-functions.build.js":1,"jquery":25}],3:[function(require,module,exports){
'use strict';
...
},{"./common-functions.build.js":1,"jquery":25}],4:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],5:[function(require,module,exports){
// 'use strict';
...
},{"./common-functions.build.js":1,"jquery":25}],7:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
(function ($) {
	$(document).ready(function () {
		...
		var footerMenuHTML = '<div class="newsletterSubscSection col_12">\
					<p>Email <a href="mailto:plugfests@microsoft.com">plugfests@microsoft.com</a> to stay updated</p>\
				</div>\
...
},{"./common-functions.build.js":1,"jquery":25}],8:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],9:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
(function ($) {
	...
	$(document).ready(function () {
		...
		$.get('/events', function (data) {
			...
			var headerImage = '<a href="/' + currentHeader.eventUrl + '"><section id="headerImage" class="mobileWrapper"><img style="width:100%; margin: 0 0 0 0; padding: 0 0 0 0;" src="../uploads/' + currentHeader.eventHomepageImage + '" /></section></a>';
			var headerBackgroundColor = '<nav class="menu-overlay desktop-menu flex" style="background-color:' + currentHeader.eventHighlightColor + ';">';
			var hamburgerMenu = '<div class="menu-overlay hamburger-menu social-icons" style="background-color:' + currentHeader.eventHighlightColor + ';">';
			var $header = $('header');
...
},{"./common-functions.build.js":1,"jquery":25}],10:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],11:[function(require,module,exports){
'use strict';
...
},{"./common-functions.build.js":1,"jquery":25}],12:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
(function ($) {
		...
		$(function () {
				...
				var locateTip = function locateTip(e) {
...
},{"./common-functions.build.js":1,"image-map-resizer":24,"jquery":25}],13:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],14:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],15:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],16:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],17:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],18:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],19:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],20:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],21:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],22:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
...
},{"./common-functions.build.js":1,"jquery":25}],23:[function(require,module,exports){
'use strict';
/*global $ */
/*global document */
/*global window */
