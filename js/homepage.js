...
$(document).ready(function () {
	//array of ms colors at 50% opacity
	var msColors = ['rgba(255, 185, 0, .5)', 'rgba(216, 659, 1, .5)', 'rgba(232, 17, 35, .5)', 'rgba(180, 0, 158, .5)', 'rgba(92, 45, 145, .5)', 'rgba(0, 120, 215, .5)', 'rgba(0, 130, 114, .5)', 'rgba(16, 124, 16, .5)'];
