...
var hashRoute = window.location.href;\
var http = "http";\
...
var tabIDName = "#" + tabid;\
var divWithTabId = "div" + tabIDName.slice(0, -4);\
$curriculumList.children().each(function(i, elem) {\
if ($(this).attr("id") === tabid) {\
var wantedTab = $(this);\
var tabs = $(this).parents("ul.tabs").find("li");\
var tab_next = tabs.filter(".current").find("a").attr("href");\
var tab_current = tabs.filter(tabIDName).find("a").attr("href");\
$(tab_current).hide();\
...
console.log($(this).parent().parent().children(divWithTabId), "    ::::::      ", divWithTabId.slice(0, -3), "    ::::::::    ", tabIDName);\
return false;\
}\
});\
});\
...
setTimeout(function() {\
  ...
  if (window.location.hash && tabsArr.indexOf(window.location.hash) < 0 && $(window.location.hash).parent().parent().parents().children("ul.tabs").find("li").find("a").length > 0) {\
    var $newDivId = "#" + $(window.location.hash).parent().parent().attr("id");\
    var $tabs2 = $(window.location.hash).parent().parent().parents().children("ul.tabs").find("li");\
    var $newTabCheck = $(window.location.hash).parent().parent().parents().children("ul.tabs").find("li").find("a");\
    var $newTab;\
  ...
  if (window.location.hash && tabsArr.indexOf(window.location.hash) < 0 && $(window.location.hash).parent().parent().parents().children("ul.tabs").find("li").find("a").length <= 0) {\
    var $newDivId3 = "#" + $(window.location.hash).parent().attr("id");\
    var $tabs3 = $(window.location.hash).parent().parents().children("ul.tabs").find("li");\
    var $newTabCheck3 = $(window.location.hash).parent().parents().children("ul.tabs").find("li").find("a");\
    var $newTab3;\
