...
.then(function() {
  return EventTab.create({
    ...
    tabNumber: 1,
    tabTitle: 'About',
    tabContent: '<a class="button orange large float-right" target="_blank" href="http://aka.ms/Pphkv8">Register</a><h3>DevDays Asia 2016 @ Taipei</h3><h4>April 19th - 21st, TAF Innovation Base</h4><p>Microsoft established the Internet of Things (IoT) Industry Development Center in October of 2015 to effectively integrate global and local partners from the ecosystem and accelerate the process of developing IoT solutions for the manufacturing, financial, health care, transportation, and retailing industries. DevDays Asia 2016 @ Taipei, directed by Industrial Development Bureau, and hosted by Microsoft and Digital Content Industry Promotion Office, will be held in April to help developers catch up with new concepts and technologies. In the three-day program, Microsoft Experienced Developers from the US will deliver lectures, host workshops, and communicate, interact, and co-create with participants to generate amazing ideas as well as solutions.</p><p>On the first day, keynote speeches about new concepts and technologies for enhancing productivity, cloud computing, and data analysis platform will be delivered by Microsoft Experienced Developers from the US. The speakers will focus on the technologies for boosting productivity and cloud & data platform.</p><p>In the Morning session of the second day, Microsoft Experienced Developers from the US will provide sample codes and share their tips and guidelines about application development. A HAOckathon ( Hackathon + A for Analytical + O for Open ) focusing on improving Social Good will be held in the afternoon of the second day. Contestants will get the chance to use latest technologies to promote social welfare with Microsoft Experienced Developers from the US.</p><p>For the remaining day and a half, Microsoft Experienced Developers from the US will help contestants implement their ideas and generate improved solutions. Aligning with the theme of promoting social welfare, contestants can choose a wide variety of topics, such as Hack for Enhancing Productivity, Hack for the Environment and Marine Eco-system, Hack for the Good, Hack for Government Open Data, Hack for University Education, etc. By better utilizing technologies, it is possible to bring good deeds to a whole new level. Generous prizes will be awarded for the contestants of Hackathon, including a Surface Pro 4, a one-year subscription to Visual Studio Enterprise with MSDN, and a one-year subscription to Office 365. </p><p>Don’t hesitate! Reserve seats with your team members to DevDays Asia 2016 @ Taipei!</p><h5>Information</h5><ul><li>Date: 19th-21st April (Tue - Thu)</li><li>Event Plan:<ul type="square"><li>Day 1 Morning: Keynote</li><li>Day 1 Afternoon + Day 2 Morning: Tracks + Workshops</li><li>Day 2 Afternoon + Day 3: HAOckathon (Hackathon)</li></ul></li><li>Contact：02-25622880 # 3671 Mr.Dai</li><li><a href="https://www.microsoft.com/taiwan/events/devdays/">DevDay Asia 2016 @Taipei 亞太開發人員技術年會 - 生產力暨物聯網應用開發元年</a></li></ul><br /><br />'
  })
})
.then(function() {
  return EventTab.create({
...
.then(function() {
  return EventTab.create({
    ...
    tabContent: '<li>Cloud Tools_Azure<ol><li>Visual Studio free download  <a href="https://www.visualstudio.com">https://www.visualstudio.com</a> </li><li>Azure portal <a href="http://portal.azure.com">http://portal.azure.com</a>  </li><li>Azure Documentation  <a href="http://azure.Microsoft.com">http://azure.Microsoft.com</a>  </li><li>Open Data On Azure <a href="https://ossonazure.bhuntr.com/api.php">https://ossonazure.bhuntr.com/api.php</a> </li></ol></li><li>Microsoft Project Oxford (Image recognition and Speech recognition API) <a href="https://www.projectoxford.ai/doc">https://www.projectoxford.ai/doc</a> Office API <a href="http://dev.office.com">http://dev.office.com</a> </li><li>Office API http://dev.office.com</li><li>Azure Web App Deployment<ul style="list-style-type:none;"><li><a href="http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/01/13/azure-amp-visual-studio-2015-web.aspx">http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/01/13/azure-amp-visual-studio-2015-web.aspx</a></li></ul></li><li>Open Source PHP:<ol><li>Build PHP-MySQL Web application with Azure<ul style="list-style-type:none;"><li><a href="http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/02/19/azurer-php-mysql-web.aspx">http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/02/19/azurer-php-mysql-web.aspx</a></li></ul><li>Build PHP website with Azure<ul style="list-style-type:none;"><li><a href="http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/01/13/azure-visual-studio-php.aspx">http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/01/13/azure-visual-studio-php.aspx</a></li></ul></ol></li><li>Cross-platform Development：<ol><li>Build Cross-platform Azure App Service with Xamarin<ul style="list-style-type:none;"><li><a href="http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/01/22/xamarin-azure-app-service.aspx">http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/01/22/xamarin-azure-app-service.aspx</a></li></ul></li></ol></li><li>Use Azure for IoT<ul style="list-style-type:none;"><li><a href="https://azure.microsoft.com/en-us/develop/iot/">https://azure.microsoft.com/en-us/develop/iot/</a> </li></ul></li><li>Virtual Machine:<ol><li>Build up Linux Virtual Machine by Azure<ul style="list-style-type:none;"><li><a href="http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/02/19/azure-vm.aspx">http://blogs.msdn.com/b/microsoft_student_partners_in_taiwan/archive/2016/02/19/azure-vm.aspx</a></li></ul></ol></li><li>IoT & Machine Learning demo : <a href="https://channel9.msdn.com/Series/mini-Connect-2016/youbike">https://channel9.msdn.com/Series/mini-Connect-2016/youbike</a> </li><li>Client: UWP : <a href="http://blogs.msdn.com/b/hermanwu/archive/2015/08/03/windows-10-uwa-uwp-app.aspx">http://blogs.msdn.com/b/hermanwu/archive/2015/08/03/windows-10-uwa-uwp-app.aspx</a></li><li>SQL Database : <a href="https://azure.microsoft.com/zh-tw/documentation/services/sql-database/">https://azure.microsoft.com/zh-tw/documentation/services/sql-database/</a> </li><li>Develop support<ol><li>.NET : <a href="http://azure.microsoft.com/zh-tw/develop/net/">http://azure.microsoft.com/zh-tw/develop/net/</a></li><li>R: <a hreg="https://azure.microsoft.com/zh-tw/documentation/articles/machine-learning-r-quickstart/">https://azure.microsoft.com/zh-tw/documentation/articles/machine-learning-r-quickstart/</a> </li><li>PHP : <a href="https://azure.microsoft.com/zh-tw/develop/php/">https://azure.microsoft.com/zh-tw/develop/php/</a> </li><li>JAVA : <a href="http://azure.microsoft.com/zh-tw/develop/java/">http://azure.microsoft.com/zh-tw/develop/java/</a> </li><li>Node.js : <a href="http://azure.microsoft.com/zh-tw/develop/nodejs/">http://azure.microsoft.com/zh-tw/develop/nodejs/</a> </li><li>IOS , Android , Windows : http://azure.microsoft.com/zh-tw/develop/mobile/ </li></ol></li><li>Microsoft Azure documentation : <a href="http://azure.microsoft.com/zh-tw/documentation/">http://azure.microsoft.com/zh-tw/documentation/</a> </li><li>Azure Website: <a href="http://azure.microsoft.com/zh-tw/">http://azure.microsoft.com/zh-tw/</a> </li><li>MSDN : <a href="http://social.msdn.microsoft.com/Forums/zh-tw/home?category=windowsazuretw">http://social.msdn.microsoft.com/Forums/zh-tw/home?category=windowsazuretw</a> </li><li>Microsoft Azure Taiwan User Group : <a href="https://www.facebook.com/groups/AzureTWUG/">https://www.facebook.com/groups/AzureTWUG/</a></li><li>MVA (Microsoft Virtual Academy) : <a href="http://www.microsoftvirtualacademy.com/">http://www.microsoftvirtualacademy.com/</a></li></ul>'
  })
})
.then(function() {
  return EventTab.create({
    ...
    tabContent: '<button id="curriculumLogoutButton" class="float-right">Logout</button>\
<div id="taipei2016-chinese-curriculum">\
...
<p>如果您沒有Office, 請在<a href="http://dev.office.com/devprogram">Office Dev Center</a>的網站上報名及填寫單表。通過 Office 365 開發人員計劃，您能拿到免費的Office 365開發人員賬戶及為期一年Office 365的訂閲。</p>\
<ol class="tabs">\
<li class="welcomeTab" data-tabId="taipei2016-curriculum-overview-cn-tab"><a href="">Office 增益集平台概述</a></li>\
<li class="welcomeTab" data-tabId="taipei2016-curriculum-registration-cn-tab"><a href="">報名注冊</a></li>\
...
<ul>\
<li><b>翻譯精靈</b> - Word 工作窗格增益集，會自動將選取的文字從文件語言翻譯為下拉式清單中選取的其他語言。</li>\
<li><b>建立圖表</b> - Excel 內容增益集，會從選取的資料建置自動圖表。</li>\
<li><b>第三方服務整合</b> - Word 或 Excel 工作窗格增益集，會自動顯示與選取的文字對應的維基百科頁面。</li>\
<li><b>豐富的資料結合</b> - Excel 中的 Bing 地圖內容增益集，會繪製石油公司的近岸設備及資源位置，包括從公司資源管理系統取得這項即時資訊。</li>\
<li><b>規格驗證</b> - 飛機元件設計規格的小節或段落會被標示為過期，因為 Word 工作窗格增益集會與商務系統通訊，以將內容與最新的規格驗證。</li>\
<li><b>開始工作流程</b> - Outlook 增益集，可以協助您根據範本建立訊息或會議邀請、插入會議位置的詳細資訊或使用者選擇的簽章，以及附加相關的文件。 </li>\
<li><b>訂單詳細資料呈現在內容</b> - 這個 Outlook 增益集可偵測電子郵件中內嵌採購單號碼或客戶編號的郵件，并在郵件中呈現訂單或客戶的詳細資料。這可能包括要採取的動作，例如核准。</li>\
</ul>\
...
<p><a href="https://msdn.microsoft.com/zh-tw/library/office/fp179924.aspx#o365_signup">注冊Office 365 開發人員網站</a></p>\
</div>\
...
<p class="indentP">2. 選擇<b>File</b> > <b>New</b> > <b>Project</b>.</p>\
<p class="indentP">3. 在<b>New Project</b>方塊中，選擇<b>Template</b> <b>Visual C#</b> > <b>Office/SharePoint</b> > <b>Office Add-in</b> (或App for Office). </p>\
<img src="../img/office-web-curriculum-taipei-15.png" />\
<p class="indentP">4. 命名該專案<b>HelloWorld</b>, 然後選擇<b>OK</b>。</p>\
<p class="indentP">5. 在此演示，選擇<b>Task pane</b>作為應用程式類型, 然後選擇<b>Next</b>。</p>\
<p class="indentP">6.  選擇 <b>Excel</b> 作為要承載外接程式中的 Office 增益集。您可以選擇多個選項，Office 增益集將運行在任何選定的應用程式中。</p>\
...
<p>如果您沒有 Excel 2016，您可以使用 Office 365 開發者網站。 請參閱<a class="welcomeTab" data-tabId="taipei2016-curriculum-registration-cn-tab">報名注冊</a>。 使用Napa開發工具讓Excel 增益集在 線上版本中運行。</p>\
<h3 id="taipei2016-vs-2015-debuging-cn">在Visual Studio中偵錯</h3>\
<p>設定中斷點。點擊<b>Start Debugging</b>或按<b>F5</b>來開始偵錯。</p>\
...
<div id="taipei2016-curricilum-welcome-en" class="tab-content" style="display: none;">\
...
<p><a href="https://dev.office.com/getting-started/addins">Getting started with Office Add-ins</a></p>\
<p><a href="https://code.visualstudio.com/Docs/runtimes/office">Office Add-ins with VS code</a></p>\
<p><a href="https://msdn.microsoft.com/EN-US/library/office/jj220077.aspx">Office Add-ins development lifecycle</a></p>\
...
<li>The first page (not shown) of the signup form is self-explanatory. Just supply the information about yourself that is requested and choose <b>Next</b>.</li>\
...
<p class="indentP">In the left navigation panel, select <strong>Users > Active Users</strong> </p>\
...
<p>To navigate back to the developer site, click on the “waffle” icon (located in the top-left corner) <strong>> Admin > Build Apps</strong>.</p>\
...
<ol>\
<li>If you’ve completed the steps in Registration, you will have access to the Office 365 Developer Site. Sign in with your credential created in Registration at <a href="http://www.portal.office.com/">www.portal.office.com</a> > Click on <b>Admin > Build Apps</b> to access your developer site.<br />If you do not have the development tool, you will be directed to <b>Add</b> the "Napa" Office 365 Development Tools.</li>\
<li>Click on <b>Build Apps</b> on the developer site to open the Napa Office 365 Development Tools web app in your browser.<br /><h3 style="margin-left: -25px" id="taipei2016-create-excel=addin-with-napa-en">Create a content add-in for Excel with Napa Office 365 Development Tool </h3></li>\
<li>Open the Napa Office 365 Development Tools web app in your browser and choose the <b>Add New Project</b> tile. (The Add New Project tile appears only if you have created other projects.)</li>\
...
<p class="indentP">2. Choose <b>File</b> > <b>New</b> > <b>Project</b>.</p>\
<p class="indentP">3. In the <b>New Project</b> dialog, choose <b>Templates</b> > <b>Visual C#</b> > <b>Office/SharePoint</b> > <b>Office Add-in</b> (or App for Office).</p>\
<img src="../img/office-web-curriculum-taipei-15.png" />\
<p class="indentP">4. Name the project <b>HelloWorld</b>, and then choose <b>OK</b>.</p>\
...
<p>Add breakpoints and click <b>Start Debugging</b> or press <b>F5</b> to start debugging.</p>\
...
<ol>\
<li>Add another pattern option called Square Waves.  The wave amplitude and cycle are controlled by the existing <b>Pattern Contrast %</b> and <b>Pattern Waves</b> controls. This task consists of the following:\
<ol type="a">\
...
<li>When you’re asked whether to run or save the installation executable, choose <b>Run</b>.</li>\
<li>In the Web Platform Installer window, choose <b>Install</b>.</li>\
</ol>\
</li>\
...
<p><b>Using Visual Studio Community 2015 </b></p>\
<ol>\
<li>In Visual Studio, in the <b>View</b> menu choose <b>Server Explorer</b>. Right click <b>Azure</b> and choose <b>Connect to Microsoft Azure subscription</b>. Follow the instructions for connecting to your Azure subscription.</li>\
<li>In Visual Studio, in <b>Server Explorer</b>, expand <b>Azure</b>, right-click <b>App Service</b>, and then choose <b>Create New App Service</b>.</li>\
<li>In the <b>Create Web App on Windows Azure</b> dialog box, provide this information: \
<ul>\
<li>Enter a unique <b>Web App name</b> for your site. Azure verifies that the site name is unique across the azurewebsites.net domain.</li>\
<li>Choose the <b>App Service plan</b> you\'re using to authorize creating this website. If you create a new plan, you also need to name it. </li>\
<li>Choose the <b>Resource group</b> for your site. If you create a new group, you also need to name it.</li>\
<li>Choose a geographical <b>Region</b> appropriate for you.</li>\
<li><b>For Database server</b>: accept the default of No database and then choose <b>Create</b>.</li>\
<li class="noStyleUL">The new website appears under the chosen resource group under <b>App Service</b> under <b>Azure</b> in <b>Server Explorer</b>.</li>\
</ul>\
</li>\
<li>Right-click the new website, and then choose <b>View in Browser</b>. Your browser opens and displays a webpage with the message "This web site has been successfully created."</li>\
<li>In the browser address bar, change the URL for the website so that it uses HTTPS and press <b>Enter</b> to confirm that the HTTPS protocol is enabled. The Office Add-in model requires add-ins to use the HTTPS protocol. </li>\
<li>In Visual Studio 2015, right-click the new website in <b>Server Explorer</b>, choose <b>Download Publish Profile</b> and then save the profile to your computer. The publish profile contains your credentials and enables you to publish your Office Add-in to the Azure website.</li>\
</ol>\
<h3 id="taipei2016-publishing-publish-add-in-azure-en">Publish your Office Add-in to the Azure website</h3>\
<ol>\
<li>With your add-in open in Visual Studio, expand the solution node in <b>Solution Explorer</b> so that you see both projects for the solution. </li>\
<li>Right-click the web project, and then choose <b>Publish</b>. \
<br />\
The web project contains Office Add-in website files so this is the project that you publish to Azure.</li>\
<li>In <b>Publish Web</b>, choose <b>Import</b>. </li>\
<li>In <b>Import Publish Settings</b>, choose <b>Browse</b>, and then browse to the place where you saved your publish profile earlier in this topic. Choose <b>OK</b> to import your profile.</li>\
<li>In <b>Publish Web</b>, on the <b>Connection tab</b>, accept the defaults and choose <b>Next</b>. \
<br />\
Choose <b>Next</b> > again to accept the default settings.</li>\
<li>On the <b>Preview</b> tab, choose <b>Start Preview</b>. The preview shows you all the files in the web project that will be published to the Azure website.</li>\
<li>Choose <b>Publish</b>. Visual Studio publishes the web project for your Office Add-in to your Azure Web Site. </li>\
...
<ol>\
<li>In Visual Studio with the Office Add-in open in <b>Solution Explorer</b>, expand the solution so that both projects are shown.</li>\
<li>Open the add-in manifest XML file.</li>\
<li>For <b>Source Location</b>: enter the URL for the add-in\'s main HTML page that you copied in the previous step after you published the add-in, for example, https://YourDomain.azurewebsites.net/Addin/Home/Home.html. </li>\
...
<li>If you’re using Visual Studio, validate the manifest by clicking on <b>Build > Publish > Perform Validation Check</b></li>\
...
console.log($(this).attr("id"), "  :::::   ", tabid);\
