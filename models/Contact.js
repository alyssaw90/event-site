...
.then(function () {
  return Contact.create({
    ...
    lastName: 'Badu-Antwi',
    newsletterSubscription: true,
    contactDescription: 'KB Badu-Antwi is a Senior Program Manager responsible for the interoperability initiative spanning the entire Data Group (including SQL Server). He has been at Microsoft for over 10 years and currently leads cross-functional domestic and international teams responsible for defining, delivering, and monitoring engineering/antitrust compliance and interoperability requirements. <br /> <br />Prior to joining the Data Group, KB served as the Program Manager on the Xbox Platform team. He graduated from Seattle Pacific University with a Bachelor’s of Science degree in Computer Science and a Master’s of Science degree in Information System Management.',
    eventRole: 'speaker',
    showOnMeetTheTeamPage: true,
...
.then(function() {
  ...
  lastName: 'Shao',
  newsletterSubscription: true,
  contactDescription: 'Jingyu Shao is a Software Engineer in the Microsoft Office Extensibility team. She works as web developer for Office developer portal: dev.office.com and Microsoft Graph portal: graph.microsoft.io. Jingyu also has developed several Office Add-ins with the new Office JavaScript API. In addition, she drives the development of interoperability tools, such as Fiddler Inspectors to parse Exchange, SharePoint, and WOPI online traffic. <br /><br />Jingyu graduated from Zhejiang University China with a master’s degree in Electronic Information Engineering.',
  eventRole: 'speaker',
  showOnMeetTheTeamPage: true,
  msTeamTitle: 'Software Engineer, Office Extensibility Team',
  showOnHomePage: false,
...
.then(function () {
  return Contact.create({
    ...
    lastName: 'Huang',
    newsletterSubscription: true,
    contactDescription: 'Christine Huang is a Principal Test Manager on the Microsoft Windows Server and Cloud Interoperability team. She manages the Microsoft Windows Server Interoperability team in China and owns the development and release efforts of test tools for interoperability events for Microsoft Windows Server Division. <br /><br />Prior to joining the Windows Server team, Christine worked as the event role of Senior Engineer and Manager across several Microsoft products, including Bing and Office. Prior to joining Microsoft, she worked as a senior Software Developer in industry. She graduated from National Taiwan University, Taiwan with a bachelor’s degree in Business Administration and a master’s degree in Computer Science from Georgia State University, USA.',
    eventRole: 'speaker',
    showOnMeetTheTeamPage: true,
...
.then(function () {
  return Contact.create({
    ...
    lastName: 'Chopra',
    newsletterSubscription: true,
    contactDescription: 'Tarun Chopra is a presently a Senior Escalation Engineer in the Microsoft Office Developer Support Open Specifications team. His primary responsibilities include helping customers implement solutions using WOPI, Exchange RPC/MAPI, ActiveSync, Web Services, Lync/Skype protocols, and Office Open XML and binary formats. Before joining Office Open Specifications team, Tarun played a vital role in helping customers to implement Windows protocols. He represented Microsoft at a couple of Plugfest/Interop global events. Authentication, LYNC/RDP, File Sharing protocols are some of his strengths.<br /><br />Prior to Microsoft, Tarun worked as a Development Lead in Developing Test Suites for Validation of Windows Open Specification and has vast experience in developing distributed systems. He played a key role in developing Parking Management Solutions for Japanese Firm and Verification of Ticketing System for Japanese Rail Network. He received a bachelor’s degree in Electronics and Telecommunication from a university in India.',
    eventRole: 'speaker',
    showOnMeetTheTeamPage: true,
...
.then(function () {
  return Contact.create({
    ...
    lastName: 'Devey',
    newsletterSubscription: true,
    contactDescription: 'Tom Devey is a Supportability Program Manager on the Microsoft Windows Interoperability team. He leads the Windows Open Specification Partner support and events. Events that includes Windows Protocol Plugfests are delivered at Microsoft regularly to Microsoft Partners who implement Active Directory, File Sharing and Remote Desktop, and other Microsoft protocols. <br /><br />Prior to joining the Windows Interoperability team, Tom served a similar event role in the Microsoft Office division, working with partners who developed Exchange, SharePoint, Open XML, and the Office Binary formats solutions.',
    eventRole: 'speaker',
    showOnMeetTheTeamPage: true,
...
.then(function () {
    return Contact.create({
      ...
      lastName: 'Han',
      newsletterSubscription: true,
      contactDescription: 'Feng Han is a Software Engineer on Windows Server Interoperability & Tools team in Shanghai, China. He has worked on the development and support of test tools for Windows interoperability for 4 years, especially on the Remote Desktop protocol family.<br /><br />He graduated from the Zhejiang University with a bachelor’s degree and graduated from Shanghai Jiao Tong University with a master’s degree in Software Engineering. Prior to joining Microsoft, Feng worked as a Software Development Engineer for 3 years at a startup company.<br /><br />His role on Interop Events is to present and support synthetic test suites, and helping partners to use these test tools to identity their product issues.',
      eventRole: 'speaker',
      showOnMeetTheTeamPage: true,
...
.then(function () {
  return Contact.create({
    ...
    lastName: 'Fang',
    newsletterSubscription: true,
    contactDescription: 'Guqing Fang is a Software Development Engineer on Test in the Microsoft Windows Server and Cloud Interoperability team in Shanghai, China. He owns the development and support efforts for Remote Desktop protocol family and Mobile Device Management test suites for Microsoft Windows Server Division. <br /><br />Prior to joining the team in Shanghai, Guqing worked as a Software Development Engineer in Test for 5 years, focusing on testing the model based testing tool SpecExplorer. Guqing graduated from Zhejiang University, Hangzhou China, with a Bachelor’s degree in Instrument Engineering.',
    eventRole: 'speaker',
    showOnMeetTheTeamPage: true,
