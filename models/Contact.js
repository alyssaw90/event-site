...
/*.then(function () {
  fs.readFile(path.join(__dirname, '../img/rich-mclain-headshot.jpg'), function (err, data) {
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/michael-bowman-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/kb-badu-antwi.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/andrew-davidoff-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Andrew',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/tom-jebo-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Tom',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/pui-leung-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Pui',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/bailey-chauner-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Bailey',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/donny-luu-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Donny',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/jinlin-xu-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Jinlin',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/bryan-burgin-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Bryan S.',
...
.then(function () {
   fs.readFile(path.join(__dirname, '../img/christine-huang.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Christine',
      ...
      contactDescription: 'Christine Huang is a Principal Test Manager in the Microsoft Windows Server and Cloud Interoperability team.   She manages the Microsoft Windows Server Interoperability team in China and owns the development and release efforts of test tools for interoperability events for Microsoft Windows Server Division. Prior to joining the Windows Server team, Christine worked as the eventRole of Senior Engineer and Manager across several Microsoft products including Bing and Office, and prior to joining Microsoft she worked as a senior Software Developer in industry.  She graduated from National Taiwan University, Taiwan with a Bachelor’s degree in Business Administration and a Master’s degree in Computer Science from Georgia State University, USA.',
      eventRole: 'speaker',
      msTeamMember: true,
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/feng-han-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Feng',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/guozhao-wu-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Guozhao',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/guqing-fang-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Guqing',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/hector-sandino-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Hector',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/jinghui-zhang-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Jinghui',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/mai-ing-cheng-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Mai-Ing',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/obaid-farooqi-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Obaid',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/tarun-chopra-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Tarun',
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/tom-devey-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Tom',
      ...
      newsletterSubscription: true,
      divId: 'tom-devey',
      contactDescription: 'Tom Devey is a Supportability Program Manager in the Microsoft Windows Interoperability team.   He leads the Windows Open Specification Partner support and events.    Events including Windows Protocol Plugfests are delivered at Microsoft regularly to Microsoft Partners implementing Active Directory, File Sharing and Remote Desktop, and other Microsoft protocols. Prior to joining the Windows Interoperability team, Tom served a similar eventRole in the Microsoft Office division working with partners who were developing Exchange, SharePoint, Open XML, and the Office Binary formats solutions.',
      eventRole: 'speaker',
      msTeamMember: true,
      msTeamTitle: 'Escalation Engineer, Open Specification Support Team',
      showOnHomePage: false,
...
.then(function () {
  fs.readFile(path.join(__dirname, '../img/yuqing-zhao-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Yuqing',
...
.then(function () {
   fs.readFile(path.join(__dirname, '../img/michelle-hammond-headshot.jpg'), function (err, data) {
    var image = data.toString('base64');
    if (err) {console.log(err)}
    return Contact.create({
      firstName: 'Michelle',
