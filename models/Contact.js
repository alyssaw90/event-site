...
.then(function() {
  ...
  lastName: 'Shao',
  newsletterSubscription: true,
  contactDescription: 'Jingyu Shao is a Software Engineer in the Microsoft Office Extensibility team. She works as a web developer for Office developer portal: dev.office.com and Microsoft Graph portal: graph.microsoft.io. Jingyu also has developed several Office Add-ins with the new Office JavaScript API. She also drives development of interoperability tools, like Fiddler Inspectors to parse Exchange, SharePoint and WOPI online traffic. <br /><br />Jingyu graduated from Zhejiang University China with a master\'s degree in Electronic Information Engineering.',
  eventRole: 'speaker',
  showOnMeetTheTeamPage: true,
  msTeamTitle: 'Software Engineer, Office Extensibility Team',
  showOnHomePage: false,
